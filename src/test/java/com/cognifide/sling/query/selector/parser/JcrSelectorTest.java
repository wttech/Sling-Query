...
public class JcrSelectorTest {
	...
	public void parseResourceType() {
		...
		final String jcrQuery = "SELECT * FROM [nt:base] WHERE s.[sling:resourceType] = 'foundation/components/parsys'";
	...
	public void parsePrimaryType() {
		...
		final String jcrQuery = "SELECT * FROM [cq:Page]";
		Assert.assertEquals(jcrQuery, JcrSelectorParser.parse(selector, "/"));
	}
	...
	public void parsePath() {
		final String selector = "cq:Page";
		final String jcrQuery = "SELECT * FROM [cq:Page] WHERE ISDESCENDANTNODE([/content])";
	...
	public void parseEmptySelector() {
		...
		final String jcrQuery = "SELECT * FROM [nt:base]";
		Assert.assertEquals(jcrQuery, JcrSelectorParser.parse(selector, "/"));
	}
	...
	public void parseEquals() {
		...
		final String jcrQuery = "SELECT * FROM [nt:base] WHERE s.[key1] = 'value'";
		Assert.assertEquals(jcrQuery, JcrSelectorParser.parse(selector, "/"));
	}
	...
	public void parseContains() {
		final String selector = "[key1*=value]";
		final String jcrQuery = "SELECT * FROM [nt:base] WHERE s.[key1] LIKE '%value%'";
		Assert.assertEquals(jcrQuery, JcrSelectorParser.parse(selector, "/"));
	}
	...
	public void parseEscapedValue() {
		...
		final String jcrQuery = "SELECT * FROM [nt:base] WHERE s.[key1] = 'value''123'";
		Assert.assertEquals(jcrQuery, JcrSelectorParser.parse(selector, "/"));
	}
	...
	public void parseMultipleConditions() {
		...
		final String jcrQuery = "SELECT * FROM [nt:base] WHERE s.[key1] = 'value1' AND s.[key2] = 'value2'";
		Assert.assertEquals(jcrQuery, JcrSelectorParser.parse(selector, "/"));
	}
	...
	public void parseMultipleConditionsWithResourceTypeAndPath() {
		...
		final String jcrQuery = "SELECT * FROM [nt:base] WHERE ISDESCENDANTNODE([/content]) AND s.[sling:resourceType] = 'foundation/components/parsys' AND s.[key1] = 'value1' AND s.[key2] = 'value2'";
		Assert.assertEquals(jcrQuery, JcrSelectorParser.parse(selector, "/content"));
	}
}
